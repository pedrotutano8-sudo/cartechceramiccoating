...
const appCss = "/assets/styles-BblZ5FX2.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    ...
    scripts: [
      {
        // Google Tag Manager
        children: `(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-TQDD757K');`
      }
    ]
  }),
  ...
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { children: [
      /* @__PURE__ */ jsx("noscript", { children: /* @__PURE__ */ jsx(
        "iframe",
        {
          src: "https://www.googletagmanager.com/ns.html?id=GTM-TQDD757K",
          height: "0",
          width: "0",
...
const $$splitComponentImporter = () => import("./index-BVeef5nU.js");
const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Premium mobile ceramic coating and paint correction across Sarasota, Longboat Key, and Lakewood Ranch. Free on-site estimate. Call (941) 278-0127."
    }, {
      property: "og:title",
      content: "Mobile Ceramic Coating & Paint Correction in Sarasota | Car Tech"
    }, {
      property: "og:description",
      content: "Premium mobile ceramic coating and paint correction across Sarasota. Free on-site estimate. Call (941) 278-0127."
    }, {
      property: "og:type",
      content: "website"
    }],
